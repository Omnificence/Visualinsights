<%@ page language="C#" autoeventwireup="true" inherits="Admin, App_Web_rgsmsy4n" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="assets/js/custom/admin.js"></script>
    <script type="text/javascript" src="assets/js/custom/adminDash.js"></script>
...
<body>
    <div class="top-nav-fixed">
        <div class="nav-relative">
            ...
            <div class="row">
                <form runat="server">
                    <asp:HiddenField ID="hdnOwners" runat="server" />
    ...
    <div id="fullpage">
        ...
        <div class="section" id="section0">
            <div class="section-1" style="display: block; height: auto; position: relative;">
                            ...
                            <div class="col-md-4">
                                    <div style="padding-left: 50px; padding-top: 5px">
                                        <div class="row" style="padding-bottom: 10px;">
                                            <div class="col-md-12" style="text-align: left;">
                                                <span style="font-family: 'Lato_Light'; font-size: 24px">List of Clients</span><br />
                                                <span style="font-family: 'Lato_Regular'; font-size: 14px"><span id="approvedC"></span>/<span id="totalC"></span> Approved</span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div>
                                                    <div class="col-md-10">
                                                        ...
                                                        <div class="col-md-12" style="text-align: center; border: 1px solid #B7BABC; padding-left: 0; padding-right: 0">
                                                            <div class="col-md-4 tabAD" style="border-right: 1px solid #B7BABC; cursor: pointer; background: #CFD1D2;" onclick="onLoad(0);$('.tabAD').css('background','white');$(this).css('background','#CFD1D2');">
                                                                All
                                                            </div>
                                                            <div class="col-md-4 tabAD" style="border-right: 1px solid #B7BABC; cursor: pointer;" onclick="onLoad(1);$('.tabAD').css('background','white');$(this).css('background','#CFD1D2');">
                                                                Approved
                                                            </div>
                                                            <div class="col-md-4 tabAD" style="cursor: pointer" onclick="onLoad(2);$('.tabAD').css('background','white');$(this).css('background','#CFD1D2');">Pending</div>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <hr style="margin-top: 10px; margin-bottom: 0; border: 0; border-top: 1px solid #CFD1D2;" />
                                            </div>
                                        </div>
                                        <div class="row" style="padding-top: 10px;">
                                            <div class="col-md-10">
                                                ...
                                                <div class="inner-addon left-addon">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Search..." onkeyup="FilterbyName(this)" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-10 alldisplay" id="CollabListDiv" style="display: block">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-10" id="admAlert">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="slide" id="slide2" data-anchor="slide2" style="margin-bottom: 40px;">
                    <div class="container" style="padding-top: 90px;">
                        ...
                        <div class="col-md-12" style="margin-top: 10px; margin-bottom: 10px;">
                            ...
                            <div class="col-md-4">
                                <select id="ddStage" onchange="onChangedFilter()" class="form-control">
                                    <option value=".informationgathering,.informationarchitecture,.storyboard,.finalartwork,.completed">All Stage</option>
                                    <option value=".informationgathering">Information Gathering</option>
                                    <option value=".informationarchitecture">Information Architecture</option>
                                    <option value=".storyboard">Storyboard</option>
                                    <option value=".finalartwork">Final Artwork</option>
                                </select>
                            </div>

                            <div class="col-md-4">
                                <select id="ddType" onchange="onChangedFilter()" class="form-control">
                                    <option value=".running,.completed">All Status</option>
...
a presentation, as a sales pitch or as a point of discussion in a meeting etc. )</span>
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="qBox" style="padding: 40px;">
                                                            <div id="qid7" data-type="ratio">
                                                                <p style="">How will you be presenting this information? </p>
                                            ...
                                            <div class="reqDiv">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="cent">
                                                            <a id="fDown" href="template/layout.xls" class="btn btn-blue">Download</a>
                                                        </div>
...
You can also upload other documents that are relevant for this project.      </div>
               ...
               <div class="slide" id="slide4" data-anchor="slide3" style="background: rgb(252, 252, 252);">
                    <div class="" style="padding-top: 60px; min-height:850px; height: 100%;  background:white;" id="project-details">
                    </div>
                </div>
            </div>
        </div>
